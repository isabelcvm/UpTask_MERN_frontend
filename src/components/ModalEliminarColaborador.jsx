...
const ModalEliminarColaboradores = ( ) => {

    const { eliminarColaborador, alerta, handleModalEliminarColaborador, modalEliminarColaborador } = useProyectos();
...
export default ModalEliminarColaboradores