                                    ...
                                    <form className='my-10' onSubmit={handleSubmit}>
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            >
                                                ...
                                                {PRIORIDAD.map(opcion =>( <option value={opcion} key={opcion}> {opcion} </option> ))  }
                                                
                                            </select>
                                        </div>
                                        <input type="submit" value= {id ? 'Guardar Cambios': 'Crear Tarea'} className='p-3 bg-sky-600 w-full uppercase font-bold cursor-pointer text-white transtion-colors rounded hover:bg-sky-800' />
                                    </form>
